...
const { latLngToS2CellId, getNeighbors } = require('../../shared/utils/s2-helper');
...
class ProviderAssignmentService {
  ...
  try {
    ...
    if (isEmergency || isInstant) {
      ...
      try {
        const { triggerEventNotification, sendNotification } = require('../notification/notification-helper');
