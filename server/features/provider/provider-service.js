...
const ProviderEarning = require('./provider-earning-model');
const PaymentRecord = require('../payment/payment-record-model');
const { sendOTP, verifyOTP, clearOTP } = require('../auth/otp-send');
    ...
    static async completeProfile(req, res) {
        ...
        try {
            ...
            if (services) {
                ...
                const { Category } = require('../system-setting/system-setting-model');
            ...
            try {
                const { generateAgreement, uploadPdfBuffer } = require('../booking/agreement-generator');
    ...
    static async updateProviderProfile(req, res) {
        ...
        try {
            ...
            if (updatedProvider.legalAcceptance && updatedProvider.legalAcceptance.agreementAccepted) {
                try {
                    const { generateAgreement, generateApprovalLetter, uploadPdfBuffer } = require('../booking/agreement-generator');
