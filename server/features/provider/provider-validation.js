...
const completeProfileSchema = z.object({
  ...
  accountNo: z.string().regex(/^[0-9]{9,18}$/, "Please enter a valid account number (9-18 digits)").optional().or(z.literal('')),
  ifsc: z.string().regex(/^[A-Z]{4}0[A-Z0-9]{6}$/, "Please enter a valid IFSC code").optional().or(z.literal('')),
