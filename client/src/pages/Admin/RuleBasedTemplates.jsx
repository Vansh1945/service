...
const STANDARD_EVENT_LABELS = {
    ...
    material_added: 'Material Added (material_added)',
    material_approved: 'Material Approved (material_approved)',
    material_rejected: 'Material Rejected (material_rejected)',
