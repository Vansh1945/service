...
const ServiceListingPage = () => {
  ...
  const applyLocalFilters = (searchValue, categoryValue) => {
    ...
    // Helper: get category ID from service.category (object or string)
    const getCatId = (cat) => (typeof cat === 'object' && cat !== null) ? cat._id : cat;
    // Helper: get category name from service.category (object or string)
    ...
    if (categoryValue && categoryValue !== 'All') {
      filtered = filtered.filter(service =>
        getCatId(service.category) === categoryValue
      );
    }
        ...
        <div className="flex flex-col flex-grow p-4">
          ...
          <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-100">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-semibold flex items-center gap-2 transition-all duration-200 ${isServiceAvailable
                ...
                <div className="flex flex-wrap gap-2">
                  {[5, 4, 3, 2, 1].map(rating => (
                    <button
                      ...
                      className={`flex items-center gap-1 px-3 py-2 rounded-lg border transition-all duration-200 ${selectedRatings.includes(rating)
