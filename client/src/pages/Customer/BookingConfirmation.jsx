                ...
                <div className="space-y-8">
                  ...
                  <div className="p-6 bg-gradient-to-r from-green-50 to-primary/5 rounded-xl border border-primary/20">
                    ...
                    <div className="text-center">
                      <p className="text-sm text-gray-700 font-medium">
                        securely with Card, UPI, Net Banking & get instant booking confirmation!
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 flex flex-col items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-105"
                    >
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-accent to-accent/90 hover:from-accent/90 hover:to-accent text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 flex flex-col items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-105"
                    >
                      <div className="flex items-center gap-2">
                        <div className="p-1 bg-white/20 rounded-xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-3 bg-gray-50 rounded-xl border border-gray-200 hover:bg-gray-100 transition-colors duration-200 flex flex-col gap-2 text-sm text-center">
