  ...
  useEffect(() => {
    if (isAuthenticated) {
      if (role === 'admin' || user?.isAdmin) {
        ...
        navigate(user?.approved ? '/provider/dashboard' : '/pending-approval', { replace: true });
      } else {
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-4 rounded-2xl border-2 transition-all duration-300 bg-gradient-to-r from-primary/5 to-transparent text-secondary placeholder-secondary/50 hover:shadow-md focus:shadow-lg font-medium border-gray-200 focus:border-primary focus:ring-4 focus:ring-primary/20 hover:border-primary/50`}
