    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <label className="block text-sm font-semibold text-secondary mb-1 font-inter">
            Dynamic UPI QR Code Expiry (Minutes)
          </label>
          <select
            value={systemSettings.bookingSettings.qrExpiryMinutes || 10}
            onChange={(e) => handleNestedChange('bookingSettings', 'qrExpiryMinutes', Number(e.target.value))}
            className="w-full px-3.5 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs font-semibold text-secondary focus:outline-none focus:border-primary focus:bg-white transition-all shadow-xs"
          >
          ...
          <p className="text-[11px] text-gray-500 font-inter">Configurable validity duration for Razorpay single-use amount-locked UPI QR codes generated by providers.</p>
        </div>
